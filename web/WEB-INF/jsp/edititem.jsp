                        ...
                        <div class="col-md-12"> 
                            ...
                            <form role="form">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="itemname" class="form-control" placeholder="ItemName" value="${itemname}"/>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon">@</span>
                                    <input type="text" name="itemprice" class="form-control" placeholder="Price" value="${itemprice}" />
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="itemcost" class="form-control" placeholder="Cost" value="${itemcost}"/>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="itemcategory" class="form-control" placeholder="Category" value="${itemcategory}"/>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="minquantity" class="form-control" placeholder="MinQuantity" value="${minquantity}"/>
                                </div>
