                    ...
                    <div class="row">
                        <div class="col-md-12"> 
                            <form role="form">
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="itemcost" class="form-control" placeholder="Cost" />
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="itemcategory" class="form-control" placeholder="Category" />
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                                    <input type="text" name="minquantity" class="form-control" placeholder="MinQuantity" />
                                </div>
